...
# def vgg16(im_shape, num_classes, batch_size, loss_fcn=loss_fcn):
#
#     """
#
#     Parameters
...
#     }
#
#     loss = loss_fcn(fc3pre)
#     update_weights_op = optimizer.minimize(loss, name='update_weights')
#     accuracy = accuracy(fc3, Y)
...
if __name__ == '__main__':
    ...
    from andnn.andnn_old import AnDNN
